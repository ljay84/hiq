...
namespace HiQPdf_Demo.Controllers
{
    public class AttachmentsAndFileLinksController : Controller
    {
        ...
        public ActionResult CreatePdf(IFormCollection collection)
        {
            ...
            string filePath1 = m_hostingEnvironment.ContentRootPath + @"\wwwroot" + @"\DemoFiles\Attach\TextAttach1.txt";
            ...
            string filePath2 = m_hostingEnvironment.ContentRootPath + @"\wwwroot" + @"\DemoFiles\Attach\TextAttach2.txt";
